...
public class ExerciseRepositoryStub implements IExerciseRepository {
    ...
    public ExerciseRepositoryStub() {
        exercises.add(new Exercise(
                "ex_1", "Pushups", List.of("Chest"), List.of("Bodyweight"),
        ...
        exercises.add(new Exercise(
                "ex_2", "Dumbbell Bench Press", List.of("Chest"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_3", "Dumbbell Flyes", List.of("Chest"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_4", "Bent Over Barbell Row", List.of("Back"), List.of("Barbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_5", "Barbell Shoulder Press", List.of("Shoulders"), List.of("Barbell"),
        ...
        exercises.add(new Exercise(
                "ex_6", "Dumbbell Shoulder Press", List.of("Shoulders"), List.of("Dumbbell"),
                ...
                3, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_7", "Side Lateral Raise", List.of("Shoulders"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_8", "Front Dumbbell Raise", List.of("Shoulders"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_9", "Barbell Curl", List.of("Biceps"), List.of("Barbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_10", "Hammer Curls", List.of("Biceps"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_11", "Concentration Curls", List.of("Biceps"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_12", "Incline Dumbbell Curl", List.of("Biceps"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_13", "Lying Triceps Press", List.of("Triceps"), List.of("E-Z Curl Bar"),
                ...
                3, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_14", "Triceps Pushdown", List.of("Triceps"), List.of("Cable"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_15", "Close-Grip Barbell Bench Press", List.of("Triceps"), List.of("Barbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_16", "Dips - Triceps Version", List.of("Triceps"), List.of("Bodyweight"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_17", "Barbell Squat", List.of("Legs"), List.of("Barbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_18", "Bodyweight Squat", List.of("Legs"), List.of("Bodyweight"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_19", "Dumbbell Lunges", List.of("Legs"), List.of("Dumbbell"),
                ...
                2, List.of("placeholder.png")));
        exercises.add(new Exercise(
                "ex_20", "Leg Press", List.of("Legs"), List.of("Machine"),
